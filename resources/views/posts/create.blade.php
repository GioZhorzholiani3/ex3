            ...
            <div class="grid grid-cols-1 md:grid-cols-2" style="margin:20px">
                ...
                <form method="POST" action="{{route('post.store')}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="post_text" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                        <small id="emailHelp" class="form-text text-muted">Post Text</small>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Post Author</label>
                        <input name="author_name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
