                ...
                <form  action="{{route('posts.update', $post->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="title" type="text" class="form-control"
                               id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="{{old('title',$post->title)}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="post_text" type="text" class="form-control"
                               id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="{{old('title',$post->post_text)}}">
                    ...
                    <div class="form-group">
                        ...
                        <input name="author_name" type="text" class="form-control"
                               id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email" value="{{old('title',$post->author_name)}}">
